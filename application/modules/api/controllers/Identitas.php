...
class Identitas extends REST_Controller {
    ...
    function index_get() {
        $nip = $this->get('nip');
        if ($nip == '') {
            $this->db->select('a.nip, a.nama, a.gelar1 as gelar_depan, a.gelar2 as gelar_belakang, d.golongan, b.jabatan, b.jenis, b.satker_id as kode_satker, b.satker as satker, b.unker_id as kode_unker, b.unker as unker, b.instansi');
            ...
            $this->db->where_in('a.status_id', array(1,2,13));

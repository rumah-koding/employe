...
class User_m extends MY_Model
{
	...
	//ajax datatable
    public $column_order = array('id','a.fullname','a.username','a.email','unker','satker','a.level','a.active',null); //set kolom field database pada datatable secara berurutan
    public $column_search = array('a.fullname','a.username','a.email','unker','satker','a.level','a.active'); //set kolom field database pada datatable untuk pencarian

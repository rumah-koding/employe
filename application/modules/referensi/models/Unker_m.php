...
class Unker_m extends MY_Model
{
	...
	//ajax datatable
    public $column_order = array('id','b.kode','b.unker','a.instansi',null); //set kolom field database pada datatable secara berurutan
    public $column_search = array('b.kode','b.unker','a.instansi'); //set kolom field database pada datatable untuk pencarian

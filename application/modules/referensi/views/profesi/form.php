				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('profesi') ? 'has-error' : null; ?>">
							<?php
							echo form_label('Jenis Profesi','profesi');
							$data = array('class'=>'form-control','name'=>'profesi','id'=>'profesi','type'=>'text','value'=>set_value('profesi', $record->profesi));
							echo form_input($data);
							echo form_error('profesi') ? form_error('profesi', '<p class="help-block">','</p>') : '';
							?>
						</div>
					</div>
				</div>
